...
class Test(object):
    def __init__(self):
        self.test = b"\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001"
        self.data = bytearray(self.test)
        self.bits_per_pixel = 8
        self.size = Size()
        self.width = 16
        self.height = 1
        print(self.width * self.height * self.bits_per_pixel / 8)
        print(len(self.data))

# a = b"\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001"
# b = bytearray(a)
a = Test()
b = PixelMap(a)
print(b[(0, 0)])
